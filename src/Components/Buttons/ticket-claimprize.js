...
class ClaimPrizeButton extends Component {
    constructor(client) {
        super(client, {
            id: "ticket-create-claim",
            type: "BUTTON"
        });
    }
    /**
    ...
    async execute(interaction) {
        ...
        const ch = await guild.channels.create({
            name: `ticket-claim-${member.user.username}`,
            type: 0,
        ...
        ch.send({
            embeds: [
                new EmbedBuilder()
                    ...
                    .addFields(
                        { name: 'Ticket Type:', value: 'Prize Claim' },
                ...
                embeds: [
                    new EmbedBuilder()
                        ...
                        .addFields(
                            ...
                            { name: "Ticket Type", value: "Claim Prize Inquiry", inline: true }
                        )
                        .setTimestamp()
                        .setFooter({ text: `Ticket System`, iconURL: guild.iconURL() })
                ]
...
module.exports = ClaimPrizeButton;