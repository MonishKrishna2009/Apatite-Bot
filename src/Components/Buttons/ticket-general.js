...
class TickGenButton extends Component {
    constructor(client) {
        super(client, {
            id: "ticket-create-general",
            type: "BUTTON"
        });
    }
    /**
    ...
    async execute(interaction) {
        ...
        const ch = await guild.channels.create({
            name: `ticket-gen-${member.user.username}`,
            type: 0,
        ...
        ch.send({
            embeds: [
                new EmbedBuilder()
                    ...
                    .addFields(
                        { name: 'Ticket Type:', value: 'General Inquiry' },
                ...
                embeds: [
                    new EmbedBuilder()
                        ...
                        .addFields(
                            ...
                            { name: "Ticket Type", value: "General Inquiry", inline: true }
                        )
                        .setTimestamp()
                        .setFooter({ text: `Ticket System`, iconURL: guild.iconURL() })
                ]
